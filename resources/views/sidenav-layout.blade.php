...
<div id="sideNavRef" class="side-nav-open">
    ...
    <a href="{{url("/submitForm")}}" class="side-bar-item">
        <i class="bi bi-graph-up"></i>
        <span class="side-bar-item-caption">Report Page</span>
    </a>

    <a href="{{url("/ReportTracker")}}" class="side-bar-item">
        <i class="bi bi-people"></i>
        <span class="side-bar-item-caption">Report Tracker</span>
    </a>

    <a href="{{url("/corruptions")}}" class="side-bar-item">
        <i class="bi bi-people"></i> News Feed</span>
    </a>
